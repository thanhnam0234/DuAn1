...
public class From_1 extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        tblSanpham1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "STT", "Mã SP", "Tên SP", "NSX", "Xuất xứ", "Kích cỡ", "Màu sắc", "Giá bán", "Số lượng"
            }
        ) {
            boolean[] canEdit = new boolean [] {
                ...
                if (sl != null) {
                    ...
                    if (Integer.valueOf(sl) <= 0) {
                        ...
                        if (Integer.valueOf(sl) > spct.getSoLuong()) {
                            ...
                            hdct.setHang(spct.getNXS());
                            hdct.setXx(spct.getXuatXu());
                            hdct.setKd(spct.getDangDan());
                            hdct.setKt(spct.getKichCo());
                            hdct.setMau(spct.getMauSac());
    ...
    private void btnHDActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnHDActionPerformed
        ...
        HoaDon hoaDon = new HoaDon(-1, Integer.valueOf(nv.getMaNV()), 5, new Date(), new Date(), 0, nv.getTenNV(), "Khách lẻ", null, "COD", "Chờ thanh toán");
        hds.add(hoaDon);
    ...
    private void btnTTActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnTTActionPerformed
        ...
        TimeLine tl1 = new TimeLine(-1, hd.getId(), new Date(), "Đặt hàng thành công");
        hds.addTL(tl1);
        
        TimeLine tl2 = new TimeLine(-1, hd.getId(), new Date(), "Thanh toán thành công");
        hds.addTL(tl2);
    ...
    private void showTableSP(List<SanPhamChiTiet> lists) {
        ...
        for (SanPhamChiTiet spct : listSP) {
            modelsp.addRow(new Object[]{i++, spct.getID(), spct.getTenSanPham(), spct.getNXS(), spct.getXuatXu(), spct.getKichCo(), spct.getMauSac(), spct.getGiaBan(), spct.getSoLuong()});
        }
    }
