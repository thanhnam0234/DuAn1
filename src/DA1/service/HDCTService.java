...
public class HDCTService {
    ...
    public boolean add(HoaDonChiTiet hdct) {
        int check = 0;
        String sql = "insert into hoadonchitiet(id_chitietsanpham,id_hd,tensp,hang,kichthuoc,kieudang,xuatxu,mau,sl,gia) values (?,?,?,?,?,?,?,?,?,?)";
        try {
            ...
            ps.setString(4, hdct.getHang());
            ps.setString(5, hdct.getKt());
            ps.setString(6, hdct.getKd());
            ps.setString(7, hdct.getXx());
            ps.setString(8, hdct.getMau());
            ps.setInt(9, hdct.getSl());
            ps.setFloat(10, hdct.getGia());
